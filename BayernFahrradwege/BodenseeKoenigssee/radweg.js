...
const rohstrecke = "Bodensee-Koenigssee-Radweg__Bayernnetz_fuer_Radler.gpx"
...
elevation.on("addline", function (evt) {
    ...
    L.marker(start, markerOptionStart).addTo(strecken).bindPopup("<p><a href='https://de.wikipedia.org/wiki/Lindau_(Bodensee)'><strong>Lindau am Bodensee</strong></a></p>");
    L.marker(finish, markerOptionsFinish).addTo(strecken).bindPopup("<p><a href='https://de.wikipedia.org/wiki/Berchtesgaden'><strong>Berchtesgaden</strong></a></p>");
