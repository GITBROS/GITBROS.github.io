...
elevation.on("addline", function (evt) {
    ...
    L.marker(start, markerOptionStart).addTo(strecken).bindPopup("<p><a href='https://de.wikipedia.org/wiki/Kahl_am_Main'><strong>Kahl am Main</strong></a></p>");
    L.marker(finish, markerOptionsFinish).addTo(strecken).bindPopup("<p><a href='https://de.wikipedia.org/wiki/Bayreuth'><strong>Bayreuth</strong></a></p>");
