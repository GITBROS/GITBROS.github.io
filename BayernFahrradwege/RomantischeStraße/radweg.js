...
const rohstrecke = "Romantische_Strasse_Bayernnetz_fuer_Radler.gpx"
...
elevation.on("addline", function (evt) {
    ...
    L.marker(start, markerOptionStart).addTo(strecken).bindPopup("<p><a href='https://de.wikipedia.org/wiki/F%C3%BCssen'><strong>Füssen</strong></a></p>");
    L.marker(finish, markerOptionsFinish).addTo(strecken).bindPopup("<p><a href='https://de.wikipedia.org/wiki/W%C3%BCrzburg'><strong>Würzburg</strong></a></p>");
